...
<div class="col-xs-6 col-md-4">
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color shadow-side">
      ...
      <form name="form">
        <div class="md-form-group float-label">
          ...
          <label>No Pendaftaran/Email</label>
        </div>
        <div class="md-form-group float-label">
    ...
    <div class="p-v-lg" style="margin-top: 10px">
        <div class="m-b"><a ui-sref="access.forgot-password" href="{{ url('/forgot-password') }}" class="text-primary _600">Lupa Password/PIN?</a></div>
        <div>Belum mendaftar? silahkan <a ui-sref="access.signup" href="{{ url('/register')}}" class="text-primary _600 text-center">Registrasi</a></div>
      </div>
    </div>
  </div>
</div>
